...
export function ServiceCard({ name, image, onClick }: ServiceCardProps) {
  return (
    ...
    >
      ...
      {/* Service Name */}
      <div className="absolute bottom-0 left-0 right-0 pb-3 px-2 flex items-end justify-center">
        <span className="text-white font-semibold drop-shadow-lg text-center text-xs leading-snug line-clamp-2 whitespace-normal">
          {name}
        </span>
      </div>
    </button>
